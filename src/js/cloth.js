...
function createObjects() {
    ...
    pos.set( 0, - 0.5, 0 );
    quat.set( 0, 0, 0, 1 );
    ground = createParalellepiped( 40, 1, 40, 0, pos, quat,  new THREE.ShadowMaterial( { opacity: 0.5 } ) );
    ...
    const arm = createParalellepiped( 0.1, 0.1, armLength + 0.4, armMass, pos, quat, baseMaterial );
    arm.castShadow = true;
